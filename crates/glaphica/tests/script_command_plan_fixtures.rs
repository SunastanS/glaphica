...
#[test]
fn startup_commit_command_plan_fixture_covers_gpu_commit_path() {
    let plan = script_command_plan_from_json_str(STARTUP_COMMIT_COMMAND_PLAN_JSON)
        .expect("startup commit command plan fixture should parse");
