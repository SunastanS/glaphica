...
fn tile_content_uv_origin(tile_index: u32) -> vec2<f32> {
...
fn sample_tile_content(tile_layer: i32, tile_index: u32, content_uv: vec2<f32>) -> f32 {
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    let mask = sample_tile_content(i32(input.atlas_layer), input.tile_index, input.uv);
