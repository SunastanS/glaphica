# Phase 1: Channel Infrastructure - Context
...
**Out of scope:**
- Runtime thread loop implementation (Phase 2)
- AppCore migration to channel-based commands (Phase 3)
- Tile lifetime safety invariants (Phase 4)
...
- **Configuration:** Fixed constants for now, tuned later via stress testing in Phase 4
...
- **GPU requirement:** Standard cargo test - no special GPU setup required for Phase 1 tests
...
- **crates/glaphica/src/app_core/**: Will consume channels in Phase 3
...
- Runtime-adjustable channel capacities - can add after Phase 4 if profiling shows need
- Detailed error severity levels - out of scope for Phase 1

</deferred>

---

*Phase: 01-channel-infrastructure*
